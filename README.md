...
#Short Description
A Python implementation of coupled evapotranspiration and runoff partitioning algorithms for hydrological analysis
Note: This code is a principle-based implementation of classical hydrological models--XAJ.	
#Project structure
├── .gitignore           
├── README.md 
├── LICENSE            
